...
class App(Base):
    ...
    asa_company_id: Mapped[str | None] = mapped_column(String(255), nullable=True)
...
class InstalledApp(TypeBase):
    ...
    asa_company_id: Mapped[str | None] = mapped_column(String(255), nullable=True, default=None)
